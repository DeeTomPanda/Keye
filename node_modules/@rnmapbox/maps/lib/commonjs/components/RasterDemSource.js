...
const NATIVE_MODULE_NAME = 'RCTMGLRasterDemSource';
...
class RasterDemSource extends _AbstractSource.default {
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(RCTMGLRasterDemSource, _extends({
...
const RCTMGLRasterDemSource = (0, _reactNative.requireNativeComponent)(NATIVE_MODULE_NAME);
