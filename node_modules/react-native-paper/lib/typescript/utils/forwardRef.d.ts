import { ForwardRefRenderFunction, PropsWithoutRef, RefAttributes, ForwardRefExoticComponent } from 'react';
export declare type ForwarRefComponent<T, P = {}> = ForwardRefExoticComponent<PropsWithoutRef<P> & RefAttributes<T>>;
/**
 ...
 */
export declare const forwardRef: <T, P = {}>(render: ForwardRefRenderFunction<T, P>) => ForwarRefComponent<T, P>;
