 ...
 */
declare const Card: {
    ({ elevation: cardElevation, onLongPress, delayLongPress, onPress, mode: cardMode, children, style, theme: themeOverrides, testID, accessible, ...rest }: (OutlinedCardProps | ElevatedCardProps | ContainedCardProps) & Props): JSX.Element;
    Content: {
